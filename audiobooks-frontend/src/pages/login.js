            ...
            <div className='bg-fuchsia-50 p-8 border-slate-300 border-2 border-solid rounded-lg'>
                <form onSubmit={handleSubmit} method="post">
                    <div className='flex flex-col justify-between h-full'>
                        <div className='font-sm text-2xl text-center mb-5'>Login</div>
                        ...
                        className='mb-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                   focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                                   dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                                   dark:focus:ring-blue-500 dark:focus:border-blue-500'
                        />
                        <div className='text-sm text-center mb-3'>Or 
                        <a className='font-bold text-violet-600' href='/register'> register </a>
                        if you haven't</div>
